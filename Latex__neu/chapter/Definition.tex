...
\begin{itemize}
  ...
  \item Tests/Fragen
  \begin{itemize}
    \item Eine Frage muss vom Benutzer erstellt werden und besitzt auch eine zugehörige Antwort. In der bisherigen Version der App werden nur Fragen im Karteikarten-Format unterstützt. Eine Ansammlung von Fragen kann zu einem Test zusammengefasst und somit gruppiert abgefragt werden.
  \end{itemize}
\end{itemize}
...
\begin{itemize}
  ...
  \item Einloggen an einem neuen Tag - zwischen 1 und 10 Punkte, je nach Anzahl der sequentiell aufeinanderfolgenden Einlogg-Tage

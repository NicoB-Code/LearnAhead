...
\def\vAbteilung{}                       %% 
\def\vBetreuer{Frau Claudia Zinser}                        %% Vorname Nachname

\def\vAbgabedatum{17.07}               %% DD. MONTH YYYY
\def\vBearbeitungszeitraum{03.10.2022 - 17.07.2023 - 42 Wochen}            %% DD.MM.YYYY - DD.MM.YYYY
...
\newsavebox{\savefig}
  ...
  \include{chapter/Planung}
  \include{chapter/Definition}
  \include{chapter/Entwurf}
